...
namespace SWAN.ViewModels
{
    public partial class HistoryViewModel : ObservableObject
    {
        ...
        public HistoryViewModel(IMessenger messenger, RMFDashboardViewModel dash)
        {
            ...
            _messenger.Register<HistoryViewModel, ConceptualControlsUpdatedMessage>(this, (r, m) =>
            {
                r.AllControls = m.UpdatedControls;
                r.UpdatePieChart();
            });
